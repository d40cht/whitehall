class OrganisationsController < PublicFacingController
  ...
  def index
    ...
    @ministerial_departments = Organisation.where(organisation_type_id: ministerial_department_type).alphabetically.all(include: [:organisation_type, { child_organisations: :organisation_type}])

    @public_corporations = Organisation.where(organisation_type_id: public_corporation_type).alphabetically
    @non_ministerial_departments = Organisation.where(organisation_type_id: non_ministerial_department_type).alphabetically
